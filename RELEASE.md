...
- `version_name`: semantic app version, for example `0.3.0`.
- `version_code`: positive integer that must increase for every Play Store release, starting with `3` for this release candidate.
